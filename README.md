...
- **Binary Search Tree (BST)** → Donor Records Management  
- **Stack (LIFO)** → Blood Issue History & Undo Feature  
...
- View recent issues
- Count total issues
- Undo last issued record (restore inventory)
...
- Compiler: Any standard C++ compiler (e.g., g++, Dev C++, CodeBlocks)
